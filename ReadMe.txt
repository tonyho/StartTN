================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : StartTN Project Overview
===============================================================================

The application wizard has created this StartTN application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your StartTN application.
...
StartTN.h
    ...
    project specific headers and declares the CStartTNApp application class.
...
StartTNDlg.h, StartTNDlg.cpp - the dialog
    These files contain your CStartTNDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named StartTN.pch and a precompiled types file named StdAfx.obj.
